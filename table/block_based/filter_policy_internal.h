...
class BloomFilterPolicy : public FilterPolicy {
 public:
  ...
  FilterBitsBuilder* GetBuilderWithContext(
      const FilterBuildingContext&, double bpk = 0.0,
      bool prefetch = false) const override;  // modified by modular filters
  ...
  static FilterBitsBuilder* GetBuilderFromContext(
      const FilterBuildingContext&, double bpk = 0.0,
      bool prefetch = false);  // modified by modular filters
