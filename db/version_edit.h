...
struct FileMetaData {
  ...
  FileMetaData(uint64_t file, uint32_t file_path_id, uint64_t file_size,
               ...
               uint32_t _num_entries = 0, uint64_t _num_reads = 0,
               uint64_t _num_tps = 0, float _prefetch_bpk = 0.0)
...
class VersionEdit {
 public:
  ...
  void AddFile(int level, uint64_t file, uint32_t file_path_id,
               ...
               const std::string& file_checksum_func_name, uint32_t num_entries,
               uint64_t num_reads, uint64_t num_tps, float prefetch_bpk) {
    ...
    new_files_.emplace_back(
        ...
        FileMetaData(file, file_path_id, file_size, smallest, largest,
                     ...
                     num_entries, num_reads, num_tps,
                     prefetch_bpk));  // modified by modular filters
  }
